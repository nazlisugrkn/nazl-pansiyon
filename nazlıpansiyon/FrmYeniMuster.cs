...
{
    public partial class FrmYeniMuster : Form
    {
        public FrmYeniMuster()
        {
            InitializeComponent();
        }
        ...
        private void BtnOda101_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "101";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda101 (Adi , Soyadi) (values '"+TxtAdi.Text+"','"+TxtSoyadi+"')" , baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        private void BtnOda102_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "102";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda102 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        private void BtnOda103_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "103";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda103 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        private void BtnOda104_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "104";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda105 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }

        private void BtnOa105_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "105";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda105 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
        ...
        private void BtnOda106_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "106";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda106 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        private void BtnOda107_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "107";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda107 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        private void BtnOda108_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "108";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda108 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        private void BtnOda109_Click(object sender, EventArgs e)
        {
            TxtOdaNo.Text = "109";
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Oda109 (Adi , Soyadi) (values '" + TxtAdi.Text + "','" + TxtSoyadi + "')", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
        }
        ...
        {
            MessageBox.Show("Yeşil Renkli Odalar Dolu Odaları Göstersin!");
        }

        private void BtnBosOda_Click(object sender, EventArgs e)
        {
            MessageBox.Show("kırmızı Renkli Odalar Boş Odaları Göstersin!");
        }

        private void FrmYeniMuster_Load(object sender, EventArgs e)
        {
            //Oda101
            baglanti.Open();
...
//Data Source=(localdb)\MSSQLLocalDB;Initial Catalog="NAZLI PANSİYON";Integrated Security=True